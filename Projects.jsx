          ...
          <div>
            ...
            >
              {projects.heading.map((line, i) => (
                <span key={i} className={i === projects.heading.length - 1 ? "text-skin-faint" : ""}>
                  {line}<br />
                </span>
              ))}
            </h2>
...
function ProjectCard({ project, delay }) {
  return (
    <div
      className="proj-card rev bg-skin-muted relative overflow-hidden group"
      ...
      <div className="p-6 pb-0">
        <div className="flex items-start justify-between mb-4">
          ...
          <span className="font-mono text-[9px] tracking-[0.12em] uppercase text-skin-ghost
            border border-skin-border/40 px-2 py-0.5">
            {project.stack}
          </span>
        </div>
